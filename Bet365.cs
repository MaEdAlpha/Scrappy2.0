...
namespace Scrappy2._0
{
    class Bet365 : XpathDirectory
    {
        ...
        private static void GrabBTTSData(string HomeTeamName, string AwayTeamName, string date, string matchTime)
        {
            ...
            // Add the match the DB
            BTTStoDB(HomeTeamName, AwayTeamName, homeOddsPath, drawOddsPath, awayOddsPath, overTwoFivePath, btsYesPath, matchTime);
        ...
        private static void BTTStoDB(string HomeTeamName, string AwayTeamName, double homeOddsPath, double drawOddsPath, double awayOddsPath, double overTwoFivePath, double btsYesPath, string matchtime)
        {
            MongoCRUD db = new MongoCRUD("MBEdge");
            {
                MatchesModel match = new MatchesModel
